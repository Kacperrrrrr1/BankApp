...
Aplikacja bankowa zbudowana w **React 18 + TypeScript + Tailwind CSS**.  
...
| Ekran | Opis |
|---|---|
| ⬆️ Wpłata | Wpłata gotówkowa z szybkimi kwotami |
| ⬇️ Wypłata | Wypłata ze sprawdzaniem salda |
| ↗️ Przelew | 3-krokowy przelew bankowy z potwierdzeniem |
...
- **Tailwind CSS 3**
- `localStorage` dla persystencji — brak backendu
